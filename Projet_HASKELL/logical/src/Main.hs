...
main = do
    ...
    putStrLn $ "Taille de la CNF : " ++ show (NormalForm.size cnf)
...
-- Création de quelques formules
    ...
    putStrLn $ "Taille de CNF 1: " ++ show (NormalForm.size cnf1)
    putStrLn $ "Taille de CNF 2: " ++ show (NormalForm.size cnf2)
